...
//! the wrapper maps to a pet state with the same table as
...
fn wrapper_cmd(ps1_name: &str) -> String {
    format!(
        "@echo off\r\n\
         rem Generated by pet (desktop pet). Runs the PowerShell wrapper next to this file.\r\n\
...
fn codex_wrapper_script(port: u16, chain: &[String]) -> String {
    ...
    out.push_str("# Generated by pet (desktop pet). Do not edit: `pet hooks install codex` regenerates it.\n");
...
fn claude_wrapper_script(port: u16) -> String {
    let mut out = String::new();
    out.push_str("#!/usr/bin/env bash\n");
    out.push_str("# Generated by pet (desktop pet). Do not edit: `pet hooks install claude-code` regenerates it.\n");
    out.push_str("# Claude Code hook wrapper: maps `hook_event_name` to a pet state and posts it.\n");
