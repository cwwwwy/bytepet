...
fn codex_wrapper_script(port: u16, chain: &[String]) -> String {
    ...
    out.push_str("# Generated by pet (desktop pet). Do not edit: `bytepet hooks install codex` regenerates it.\n");
...
fn claude_wrapper_script(port: u16) -> String {
    let mut out = String::new();
    out.push_str("#!/usr/bin/env bash\n");
    out.push_str("# Generated by pet (desktop pet). Do not edit: `bytepet hooks install claude-code` regenerates it.\n");
